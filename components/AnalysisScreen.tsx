...
const AnalysisScreen: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const timeout2 = setTimeout(() => {
            setPhase(2);
            setDetections([
                { id: 999, x: 35, y: 45, label: 'Bullous Emphysema' }, // Left arrow (detected feature)
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-slate-950 relative overflow-hidden">
            ...
            <div className="relative w-full max-w-4xl aspect-[4/3] bg-black border border-slate-800 rounded-xl overflow-hidden shadow-2xl">
                ...
                {phase >= 2 && (
                    <>
                        <div className="absolute top-[32%] left-[33%] w-24 h-24 border-2 border-orange-500 rounded-full animate-pulse shadow-[0_0_30px_rgba(249,115,22,0.4)] flex items-center justify-center">
